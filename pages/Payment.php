                        ...
                        <div class="payment-body">
                            <div class="payment-plan">
                                <div class="payment-plan-type">
                                    <img src="../images/images_courses/<?php echo $row['anh_khoahoc']?>" class="imagesCourses"  alt="">
                                </div>
                ...
                <div class="payment-right">
                    <div action="" class="payment-form">
                        ...
                        <div class="payment-method">
                            <form action="payment_momo.php"  class="payment-method-item" method="POST" enctype="application/x-www-form-urlencoded">
                                <input type="hidden" value="<?= $idKH ?>" name="idKH" id="idKH"> 
                                <input type="hidden" value="<?= $row['gia_khoahoc'] ?>" name="tongtien" id="tongtien"> 
                                <button type="submit"><img src="../images/Logo-MoMo-Square.webp" alt=""></button>
                            </form>
                            <form action="payment_vnpay.php"  class="payment-method-item" method="POST" enctype="application/x-www-form-urlencoded">
                                <input type="hidden" value="<?= $idKH ?>" name="idKH" id="idKH"> 
                                <input type="hidden" value="<?= $row['gia_khoahoc'] ?>" name="tongtien" id="tongtien"> 
                                <input type="hidden" name="redirect" id="redirect"> 
                                <button type="submit"><img src="../images/06ncktiwd6dc1694418196384.png" alt="" name="redirect"></button>
                            </form>
                        </div>
                        ...
                        <a href="checkout.php?courses=<?=$idKH?>&method=1" class="payment-form-submit-button"><i class="ri-wallet-line"></i> Thanh toán</a>
